        ...
        <section id="about" className="py-20 bg-white">
            <div className="max-w-5xl mx-auto px-6">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className="mt-4 text-slate-600 leading-relaxed max-w-2xl mx-auto text-justify">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {/* Left Section */}
                    <div>
                        <h3 className="text-2xl font-bold text-slate-800 mb-4">Crafting Digital Experiences</h3>
                    ...
                    <div className="grid grid-cols-2 ml-10 sm:grid-cols-2 gap-6">
                        {/* Personal Info */}
                        <div className="bg-slate-50 p-5 rounded-lg shadow-md">
                            ...
                            <ul className="mt-2 text-slate-600 text-sm">
                        ...
                        <div className="bg-slate-50 p-5 rounded-lg shadow-md">
                            ...
                            <h4 className="text-lg font-semibold text-slate-800">Experience</h4>
                            <ul className="mt-2 text-slate-600 text-sm">
                        ...
                        <div className="bg-slate-50 p-5 rounded-lg shadow-md">
                            ...
                            <h4 className="text-lg font-semibold text-slate-800">Tech Stack</h4>
                            <ul className="mt-2 text-slate-600 text-sm">
